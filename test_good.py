...
The dataset: images/split_data/test contain testing images arranged in subfolders where the names of the subfolders
 are the class name. The dataset has three classes (OSCC, with-dysplasia and without-dysplasia). These images are
  histopathological images for oral cancer.
